...
import { LogOut, PackageSearch, LayoutDashboard, ShoppingBag, Users, Layers, MapPin, Repeat2, ArrowLeftRight } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { name: 'Pickup Slots', path: '/admin/pickup-slots', icon: MapPin },
    { name: 'Returns', path: '/admin/returns', icon: Repeat2 },
    { name: 'Exchanges', path: '/admin/exchanges', icon: ArrowLeftRight },
    { name: 'Audit Logs', path: '/admin/audit-logs', icon: LayoutDashboard },
  ];
